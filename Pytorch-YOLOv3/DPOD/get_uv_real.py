...
image_list = glob("C:/Users/IVCL/Desktop/crane/real_image2/*.png")
...
for num in range(0,len(image_list)):
    ...
    # Save images
    cv2.imwrite("C:/Users/IVCL/Desktop/crane/real2_mask/%s"%image_list[num][-14:], ID_mask)
    cv2.imwrite("C:/Users/IVCL/Desktop/crane/real2_U_mask/%s"%image_list[num][-14:], U_mask*255)
    cv2.imwrite("C:/Users/IVCL/Desktop/crane/real2_V_mask/%s"%image_list[num][-14:], V_mask*255)